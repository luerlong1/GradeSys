...
<div class="container higher" id="container">
    ...
    <div class="tab-content" style="background-color: #ddd;">
        <form action="orgroom/album/update.action" method="post" id="album-form">
            ...
            <input type="hidden" value="${orgroom.originId}" name="originId" id="classId">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    ...
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <button class="btn btn-default" type="button" onclick="location.href='orgroom/album.action?originId=${orgroom.originId}'">
                        取 &nbsp;&nbsp; 消</button>
                </div>
            </div>
        </form>
